...
function createData(name: string, calories: number, fat: number, carbs: number, protein: number): IData {
    return {
        name,
        calories,
        fat,
...
function getComparator<TKey extends keyof any>(
    order: TOrder,
    orderBy: TKey
): (a: { [key in TKey]: number | string }, b: { [key in TKey]: number | string }) => number {
    return order === 'desc'
